    ...
    internal static class ModEventHook
    {
        ...
        public static void EntityKilled(Entity killedEntity, Entity entityThatKilledMe)
        {
               ...
               && entityThatKilledMe.IsClientControlled())
            {
                ...
                Task.Factory.StartNew((state) =>
                {
                    _hub.OnEntityKilled((KilledEntity)state);
                }, new KilledEntity() { DeadEntity = entity, KillerEntityId = killerEntityId });
            }
        }
        ...
        public static void EntitySpawned(EntityInfo entity)
        {
            Task.Factory.StartNew((state) =>
            {
                _hub.OnEntitySpawned((EntityInfo)state);
            }, entity);
        }
        ...
        {
            var obj = clientInfo.ToSpawnedPlayer(respawnType, position);

            Task.Factory.StartNew((state) => _hub.OnPlayerSpawnedInWorld((SpawnedPlayer)state), obj);
        }
        /// <summary>
